# -*- coding: utf-8 -*-
"""
pusula_veri_uret.py — Pusula (React SPA, docs/v2/) için statik veri üretici.
══════════════════════════════════════════════════════════════════════════
...
dönüştürülüp docs/v2/data/ altına yazılır.

BU DOSYA v2 KOPYASIDIR: V1'in pusula_veri_uret.py'sinden birebir kopyalanmış,
tek fark HEDEF_KLASOR'un docs/pusula/data yerine docs/v2/data'ya işaret
etmesidir (v2'nin kendi arayüzü ve kendi veri klasörü ayrı tutulur).
...
# v2/pusula_veri_uret.py -> repo kökü -> docs/v2/data
HEDEF_KLASOR = os.path.join(KLASOR, "..", "docs", "v2", "data")
